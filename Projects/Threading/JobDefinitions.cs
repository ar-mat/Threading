...
namespace Armat.Threading
{
	...
	public enum JobCreationOptions
	{
		...
		/// <summary>
		/// A hint to a <see cref="Armat.Threading.JobScheduler">DedicatedThreadPool</see> to schedule a
		...
		/// <see cref="Armat.Threading.JobScheduler">DedicatedThreadPool</see> that oversubscription may be
		/// warranted.
		/// </summary>
		LongRunning = 0x02,
		...
		/// like StartNew or ContinueWith that are performed in the created job will see Armat.Threading.DedicatedThreadPool.Default as the current pool.
		/// </summary>
		HideScheduler = 0x10,
